...
class EVUser:
    ...
    def _calculate_plug_in_time(self, base_hour: int, base_minute: int) -> TimeType:
        """
        Calculate plug-in time with random variation.
        ...
        """
        variation = random.gauss(0, st.session_state.variance.plug_in_time_std)  # Standard deviation of 0.5 hours
    ...
    def _calculate_plug_out_time(self, base_hour: int, base_minute: int) -> TimeType:
        """
        Calculate plug-out time with random variation.
        ...
        """
        variation = random.gauss(0, st.session_state.variance.plug_out_time_std)  # Standard deviation of 0.5 hours
